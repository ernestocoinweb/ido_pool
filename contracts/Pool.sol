...
contract Pool {
    ...
    /** 
     * @dev Edit the pool data. Only editing endDateTime, should add the rest of the parameters.
     */
    function editPoolData(uint _endDateTime) public {
	require(msg.sender == poolOwner,"Only the owner of the pool can edit it");
